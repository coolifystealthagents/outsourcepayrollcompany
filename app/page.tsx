    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Payroll compliance binder</p>
          <h1>Outsource Payroll Company: a payroll binder for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsource payroll company guide for companies comparing payroll outsourcing support and admin help. The page now uses a distinct traditional institutional layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>binder tabs and payroll calendar</figcaption></figure>
      </div>
    </section>
