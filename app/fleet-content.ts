...
const topics = [
  ...
  ,['philippines-payroll-remittance-reconciliation','Philippines payroll remittance reconciliation','How to research payroll remittance records against approved payroll outputs and filing evidence.','The Bureau of Internal Revenue publishes official Philippine tax resources for employers.','Remittance reconciliation is strongest when the payroll population, filing record, payment evidence, and reviewer are connected.','2026-08-11']
  ,['philippines-payroll-employee-status-changes','Philippines payroll employee status changes','A research brief on validating employee status changes before they affect payroll treatment.','The Department of Labor and Employment publishes Philippine labor and employment resources.','Status-change review needs an effective date, authoritative source, payroll impact, and accountable approver.','2026-08-11']
  ,['philippines-payroll-benefit-deduction-reconciliation','Philippines payroll benefit deduction reconciliation','Evidence-led analysis for comparing benefit deductions with approved enrollment and payroll records.','The National Privacy Commission publishes guidance for organizations processing personal information.','Deduction reconciliation should identify the source population, change reason, variance, and decision owner.','2026-08-11']
  ...
  ,['philippines-payroll-filing-calendar-controls','Philippines payroll filing calendar controls','How authoritative filing dates and payroll cutoffs can be studied together without losing ownership.','The Bureau of Internal Revenue publishes official filing and tax information for Philippine employers.','A filing calendar control should show the applicable obligation, source date, preparer, reviewer, and escalation point.','2026-08-11']
  ,['philippines-payroll-employee-record-correction','Philippines payroll employee record correction','A research-led model for assessing corrections to payroll employee records before they flow downstream.','The National Privacy Commission addresses safeguards for personal-information processing.','Record correction requires a source request, field-level change, effective date, reviewer, and confirmation step.','2026-08-11']
  ,['philippines-payroll-payroll-output-variance','Philippines payroll output variance','How to interpret differences between payroll inputs, approved results, and provider outputs.','The Bangko Sentral ng Pilipinas publishes national payment-system measurement resources.','Output variance should trigger evidence review and owner judgment rather than an automatic correction.','2026-08-11']
  ,['philippines-payroll-review-evidence-retention','Philippines payroll review evidence retention','A research brief on retaining enough payroll review evidence to support later examination.','The Data Privacy Act is administered by the Philippine National Privacy Commission.','Evidence retention should balance reviewability, purpose, access limits, and a defined review or deletion point.','2026-08-11']
  ,['philippines-payroll-deadline-exception-analysis','Philippines payroll deadline exception analysis','An evidence-led way to study late payroll inputs and the decisions that resolve them.','The Philippine Development Plan 2023–2028 uses indicators to monitor national priorities.','Deadline analysis becomes useful when each late item has a cause, owner, impact, and prevention decision.','2026-08-11']
  ,['philippines-payroll-approval-evidence-completeness','Philippines payroll approval evidence completeness','How to assess whether payroll approvals can be independently understood from their records.','The Official Gazette publishes laws and issuances of the Republic of the Philippines.','Approval evidence is complete when the decision, source, scope, reviewer, date, and exception treatment are traceable.','2026-08-11']
] as const;
